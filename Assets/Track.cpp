...
void DrawTrack( int x,int y,D3DGraphics* gfx )
{
    ...
    {
        gfx->DrawLine( x,y + row,x + 599,y + 20 + row,
    ...
    for( int row = 0; row < 20; row++ )
    {
        gfx->DrawLine( x,y + 580 + row,x + 599,y + 580 + row,
                       D3DCOLOR_XRGB( 168,0,168) );
    }
    // Draw south inner
    for( int row = 0; row < 40; row++ )
    ...
    {
        gfx->DrawLine( x + 580 + col,y + 60,x + 580 + col,y + 540,
                       D3DCOLOR_XRGB( 168,0,168) );
    }
    // Draw east inner
    ...
    for( int col = 0; col < 20; col++ )
    {
        gfx->DrawLine( x + col,y + 80,x + col,y + 520,
                       D3DCOLOR_XRGB( 168,0,168) );
    }
    // Draw west inner
    for( int col = 0; col < 40; col++ )
